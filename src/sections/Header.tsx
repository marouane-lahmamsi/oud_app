      ...
      <div className="container-oud">
        <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <SheetContent side="left" className="w-[300px] bg-[#FAF7F2]">
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between mb-8">
                  <Link to="/" className="font-serif text-2xl font-semibold" onClick={() => setIsMobileMenuOpen(false)}>
                    Oud Premium
                  </Link>
                </div>
          ...
          <Link to="/" className="flex-shrink-0">
            <h1 className="font-serif text-xl lg:text-2xl font-semibold text-stone-900">
              Oud<span className="text-amber-600">Premium</span>
            </h1>
          </Link>
